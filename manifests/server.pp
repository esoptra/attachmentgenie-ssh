...
class ssh::server (
  ...
  Optional[Enum['yes','no']] $debian_banner = $::ssh::params::debian_banner,
  Enum['yes','no'] $gateway_ports = $::ssh::params::gateway_ports,
  Enum['yes','no'] $gssapi_authentication = $::ssh::params::gssapi_authentication,
  Enum['yes','no'] $gssapi_keyexchange = $::ssh::params::gssapi_keyexchange,
  Enum['yes','no'] $gssapi_cleanupcredentials = $::ssh::params::gssapi_cleanupcredentials,
  Array $host_keys = $::ssh::params::host_keys,
  Enum['yes','no'] $kerberos_authentication = $::ssh::params::kerberos_authentication,
  ...
  Enum['yes','no'] $permit_tunnel = $::ssh::params::permit_tunnel,
  Optional[Enum['yes','no']] $permit_tty = $::ssh::params::permit_tty,
  ...
  Enum['yes','no'] $print_motd = $::ssh::params::print_motd,
  Enum['yes','no'] $pubkey_authentication = $::ssh::params::pubkey_authentication,
  ...
  Enum['yes','no'] $use_dns = $::ssh::params::use_dns,
  Enum['yes','no'] $use_pam = $::ssh::params::use_pam,
  Enum['yes','no','sandbox'] $use_privilege_separation = $::ssh::params::use_privilege_separation,
